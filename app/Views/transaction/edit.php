...
<div class="content-wrapper">
    <div class="container main-container" style="max-width: 100%">
        ...
        <!-- Form Start -->
        <form id="transactionForm" action="<?= base_url('/edit') ?>" method="post">
            ...
            <div id="transactionContainer">
                ...
                <div class="transaction-block fade-in">
                    ...
                    <div class="row g-3">
                        <input type="hidden" name="transaction_id[id]" value="<?= $transaction['id'] ?? 0 ?>">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <input type="date[]" name="date"
                                value="<?= !empty($transaction['date']) ? date('Y-m-d', strtotime($transaction['date'])) : '' ?>"
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <input type="text" name="voucher_no[]"
                                value="<?= isset($transaction['voucher_no']) ? $transaction['voucher_no'] : ''; ?>"
                                class="form-control" placeholder="Enter voucher number" required>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <select name="type[]" class="form-select type-select" required>
                                ...
                                <option value="1" <?= ($transaction['type'] == 1) ? 'selected' : '' ?>>💰 Income</option>
                                <option value="2" <?= ($transaction['type'] == 2) ? 'selected' : '' ?>>💸 Expense</option>
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <select name="payment_mode[]" class="form-select" required>
                                ...
                                <?php foreach ($paymentModes as $mode): ?>
                                    <option value="<?= $mode['id']; ?>" <?= (isset($transaction['payment_mode']) && $transaction['payment_mode'] == $mode['id']) ? 'selected' : ''; ?>>
                                        <?= $mode['name']; ?>
                                    </option>
                                <?php endforeach; ?>
                        ...
                        <div class="col-md-12 col-lg-4">
                            ...
                            <textarea name="remarks[]" class="form-control" rows="1"
                                placeholder="Add notes or remarks (optional)"><?= isset($transaction['remarks']) ? $transaction['remarks'] : ''; ?></textarea>
                        </div>
...
<script>
    ...
    $(document).on("change", ".type-select", function () {
        ...
        categoryDropdown.html('<option value="">Loading...</option>').prop('disabled', true);
